...
from efficientnet_pytorch.efficientnet.models import simple_dual

mels_data_root = './data/output/figures_split/mels'
mfcc_data_root = './data/output/figures_split/mfcc'
OUTPUT_DIR = './checkpoints/dual'
TRAIN_ACC_HISTORY = 'dual_train_acc_history.txt'
TRAIN_LOSS_HISTORY = 'dual_train_loss_history.txt'
VAL_ACC_HISTORY = 'dual_val_acc_history.txt'
VAL_LOSS_HISTORY = 'dual_val_loss_history.txt'
LEARNING_RATE = 1e-4
EPOCHS = 100
SPLIT=4
...
class Trainer():
    ...
    def fit(self):
        ...
        for self.epoch in epochs:
            ...
            self.save_checkpoint(os.path.join(self.output_dir, 'dual_epoch{}_validloss{}_checkpoint.pth'.format( self.epoch, valid_loss.value)))
...
def main():
    ...
    model = simple_dual.DualInputNetwork(n_classes = 7)
